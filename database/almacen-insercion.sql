...
(1,2,1,'Entrada', 90, '2023/05/20', ''),
(1,3,1,'Entrada', 120, '2023/05/20', ''),
(1,4,1,'Entrada', 150, '2023/05/20', ''),
(2,5,1,'Entrada', 80, '2023/05/20', ''),
(2,6,1,'Entrada', 90, '2023/05/20', ''),
(2,7,1,'Entrada', 100, '2023/05/20', ''),
(2,8,1,'Entrada', 115, '2023/05/20', ''),
(3,9,1,'Entrada', 70, '2023/05/20', ''),
(3,10,1,'Entrada', 110, '2023/05/20', ''),
(3,11,1,'Entrada', 90, '2023/05/20', ''),
(3,12,1,'Entrada', 60, '2023/05/20', ''),
(4,13,1,'Entrada', 180, '2023/05/20', ''),
(4,14,1,'Entrada', 120, '2023/05/20', ''),
(4,15,1,'Entrada', 130, '2023/05/20', ''),
(4,16,1,'Entrada', 140, '2023/05/20', ''),
(5,17,1,'Entrada', 100, '2023/05/20', ''),
(5,18,1,'Entrada', 80, '2023/05/20', ''),
(5,19,1,'Entrada', 120, '2023/05/20', ''),
(5,20,1,'Entrada', 90, '2023/05/20', '')
SELECT * FROM movimientos

INSERT INTO movimientos(idtipoprenda,idprenda, idusuario, tipo, cantidad, fecha, observaciones) VALUES
(1,1,1,'Salida', 5, '2023/05/21', 'Se encuentran mal cocidos'),
(1,2,1,'Salida', 50, '2023/05/21', 'Para ventas'),
(2,7,1,'Salida', 90, '2023/05/21', 'Para ventas'),
(2,8,1,'Salida', 10, '2023/05/21', 'Prendas con fallos'),
(3,11,1,'Salida', 80, '2023/05/21', 'Para ventas'),
(3,12,1,'Salida', 2, '2023/05/21', 'Las camisas estan manchadas'),
(4,13,1,'Salida', 100, '2023/05/21', 'Para ventas'),
(4,14,1,'Salida', 100, '2023/05/21', 'Para ventas'),
(5,19,1,'Salida', 60, '2023/05/21', 'Para ventas'),
(5,20,1,'Salida', 1, '2023/05/21', 'Cierre mal colocado')